      ...
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
        ...
        <div>
            ...
            <ul className="space-y-2 text-sm text-gray-300 font-serif">
                <li><a href="#" className="hover:text-white transition-colors">World Politics</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Economy</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Technology Futures</a></li>

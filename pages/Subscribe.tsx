...
export const Subscribe: React.FC = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (mode === 'register') {
            ...
            if (register(name, email, password, 'subscriber')) {
                // Auto-login flow
                const user = login(email, password, 'subscriber');
                if (user) {
                    navigate('/');
                } else {
    ...
    // If Payment is Disabled, show a cleaner, centered "Registration" page
            ...
            <div className="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-paper">
                <div className="max-w-md w-full bg-white p-10 shadow-2xl border-t-4 border-ink relative">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button 
                            type="submit" 
                            className="w-full bg-ink text-white font-bold uppercase tracking-widest py-4 hover:bg-gold hover:text-ink transition-colors mt-4 shadow-lg"
                        >
                            {mode === 'register' ? 'Create Free Account' : 'Secure Login'}
                        </button>
                    </form>
    ...
    // Default Split Layout with Payment/Marketing Pitch
    return (
            ...
            <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 shadow-2xl overflow-hidden rounded-lg">
                ...
                <div className="bg-white p-8 md:p-12 flex flex-col justify-center">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button 
                            type="submit" 
                            className="w-full bg-ink text-white font-bold uppercase tracking-widest py-4 hover:bg-gold hover:text-ink transition-colors mt-4"
                        >
                            {mode === 'register' ? 'Continue to Payment' : 'Access Account'}
                        </button>
                    </form>
